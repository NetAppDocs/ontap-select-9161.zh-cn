...
带有调解器的双节点集群可以跨越两个数据中心。有关更多信息，请参阅link:reference_plan_best_practices.html#two-node-stretched-ha-metrocluster-sds-best-practices["双节点扩展 HA (MetroCluster SDS) 最佳实践"] 。
